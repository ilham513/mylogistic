...
<nav class="navbar navbar-expand-lg navbar-light bg-light px-2">
  <div class="container-fluid">
    <a class="navbar-brand " href="#">Nama PT</a>
    <button
	...
	<div class="container row px-5">
		<div class="col-7 px-5 align-self-center">
		  	<div class="container mt-5">
				<h1 class="mb-3 fw-bold">Lorem Ipsum</h1>

				<form action="latihan1_go.php" method="post">
				  
				  <div class="form-group mb-3">
					<label for="exampleFormControlSelect1" class="mb-1">Lorem Ipsum Sir Amit</label>
		...
		<div class="col-5">
		  <img class="mt-5" width="700px" src="img/main.png"/>
		</div>
	</div>
