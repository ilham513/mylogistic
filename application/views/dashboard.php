    ...
    <div class="container pt-4">
      ...
      <section>
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 col-12 mb-4">
			...
			<?php
				...
				$diff = $tgl2->diff($tgl1);			
			?>
			<div class="alert alert-danger <?=$diff->format("%a") > 3 && $pengiriman->id_status <2 ? '' : 'd-none';?>" role="alert">
			  <?php
		...
		foreach($grafik as $grafik){
			$tanggal_pengiriman[] = $grafik->tanggal_pengiriman;
			$count[] = $grafik->count;
		}
