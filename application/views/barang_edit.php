...
<header>
  ...
  <main style="margin-top: 58px">
	...
	<form action="<?=site_url('Barang/edit_go')?>" method="post">
	 <!-- Section: Main chart -->
		  <section class="mb-4">
			<div class="card">
			  ...
			  <div class="card-body">
				  <input name="id_barang" type="hidden" id="form6Example3" class="form-control" value="<?=$obj_barang->id_barang?>"/>
				  
				  <!-- input -->
				  <div class="form-outline mb-4">
					<input name="nama_barang" type="text" id="form6Example3" class="form-control" value="<?=$obj_barang->nama_barang?>"/>
					<label class="form-label" for="form6Example3">Nama Barang</label>
				  </div>

				  <!-- input -->
				  <div class="form-outline mb-4">
					<input name="jenis_barang" type="text" id="form6Example3" class="form-control" value="<?=$obj_barang->nama_barang?>"/>
